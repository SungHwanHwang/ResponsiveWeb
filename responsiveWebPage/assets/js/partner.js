var samTag = '<p>- ONLINE 시스템 개발/공급, ONLINE/DLPS 운영(삼성전자, 삼성전자 중국 소주/시안 사업장) <br/><br/>- EDS TEST SYSTEM WEB VERSION 개발/공급<br/><br/>- Inkless Wafer-Map 시스템 개발/공급<br/><br/>- WAPS(Wire-bonder Auto Processing System) 시스템 개발/공급<br/><br/>- SECS I/II & HSMS Communication Driver 개발/공급<br/><br/>- 2D바코드 리더 개발/공급(삼성전자, 삼성전자 중국 소주/시안 사업장)<br/><br/>- IMS PC(E-BOX) 개발/공급<br/><br/>- RCS 시스템 개발/공급(삼성LED 중국 텐진 사업장)</p>';
...
function makePartnerContent(id, tag, imageId) {
	deleteBorder();
	drawBorder(imageId);		
	$("#partnerMain").fadeOut('slow', function(){
